...
public class collectApiStepdefinitions {
    ...
    public void kullanici_path_parametreleri_olarak_economy_currency_to_all_kullanir() {

    }
    @Then("kullanici query parametrei olarak {string} olarak {int} {string} olarak {string} girer")
    public void kullanici_query_parametrei_olarak_olarak_olarak_girer(String string, Integer int1, String string2, String string3) {
